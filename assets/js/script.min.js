  ...
  (function (e) {
    ...
    function t(t, C) {
      function T(t) {
        if (
          !(
            !0 === _e.data(E + "_intouch") ||
            e(t.target).closest(C.excludedElements, _e).length > 0
          )
        ) {
          ...
          if (
            ...
            return (
              ...
              l
                ? (xe = l.length)
                : !1 !== C.preventDefaultEvents && t.preventDefault(),
              (pe = 0),
              (he = null),
              (fe = null),
              (we = null),
              ...
              K(),
              X(0, c),
              !l || xe === C.fingers || C.fingers === v || U()
                ? ((Ee = oe()),
                  2 == xe &&
                    (X(1, l[1]), (me = ve = re(Se[0].start, Se[1].start))),
                  (C.swipeStatus || C.pinchStatus) && (a = P(s, $e)))
                : (a = !1),
              !1 === a
                ? (P(s, ($e = _)), a)
                : (C.hold &&
                    (qe = setTimeout(
                      e.proxy(function () {
                        _e.trigger("hold", [s.target]),
                          C.hold && (a = C.hold.call(_e, s, s.target));
                      }, this),
                      C.longTapThreshold
                    )),
                  Z(!0),
      ...
      function O(t) {
        var u,
          ...
          p,
          h,
          f = t.originalEvent ? t.originalEvent : t;
        if ($e !== b && $e !== _ && !V()) {
          var A,
            y = f.touches,
            $ = J(y ? y[0] : f);
          if (
            ((Ce = oe()),
            y && (xe = y.length),
            C.hold && clearTimeout(qe),
            ($e = w),
            2 == xe &&
              (0 == me
                ? (X(1, y[1]), (me = ve = re(Se[0].start, Se[1].start)))
                : (J(y[1]),
                  (ve = re(Se[0].end, Se[1].end)),
                  Se[0].end,
                  Se[1].end,
                  (we = Ae < 1 ? a : s)),
              (Ae = ((ve / me) * 1).toFixed(2)),
              (ye = Math.abs(me - ve))),
            xe === C.fingers || C.fingers === v || !y || U())
          ) {
            if (
              ((he = ie($.start, $.end)),
              (function (e, t) {
                if (!1 !== C.preventDefaultEvents)
                  if (C.allowPageScroll === l) e.preventDefault();
                    ...
                    var s = C.allowPageScroll === c;
                    switch (t) {
                      case n:
                        ((C.swipeLeft && s) ||
                          (!s && C.allowPageScroll != g)) &&
                          e.preventDefault();
                        break;
                      case r:
                        ((C.swipeRight && s) ||
                        ...
                        break;
                      case i:
                        ((C.swipeUp && s) || (!s && C.allowPageScroll != m)) &&
                          e.preventDefault();
                        break;
                      case o:
                        ((C.swipeDown && s) ||
                          (!s && C.allowPageScroll != m)) &&
                          e.preventDefault();
                    }
                  }
              })(t, (fe = ie($.last, $.end))),
              ...
              (ge = ne()),
              (function (e, t) {
                e != l && ((t = Math.max(t, ee(e))), (be[e].distance = t));
              })(he, pe),
              (A = P(f, $e)),
              ...
              !C.triggerOnTouchEnd && x
                ? ($e = j(w))
                : C.triggerOnTouchLeave && !x && ($e = j(b)),
                ($e != _ && $e != b) || P(f, $e);
            }
          } else P(f, ($e = _));
          !1 === A && P(f, ($e = _));
      ...
      function D(e) {
        ...
        return (
          ...
          R() || !N()
            ? P(t, ($e = _))
            : C.triggerOnTouchEnd || (!1 === C.triggerOnTouchEnd && $e === w)
            ? (!1 !== C.preventDefaultEvents &&
                !1 !== e.cancelable &&
                e.preventDefault(),
              P(t, ($e = b)))
            : !C.triggerOnTouchEnd && F()
            ? I(t, ($e = b), p)
            : $e === w && P(t, ($e = _)),
          Z(!1),
          null
      ...
      function L() {
        (xe = 0), (Ce = 0), (Ee = 0), (me = 0), (ve = 0), (Ae = 1), K(), Z(!1);
      }
      function q(e) {
        var t = e.originalEvent ? e.originalEvent : e;
        C.triggerOnTouchLeave && P(t, ($e = j(b)));
      }
      function k() {
        _e.unbind(ae, T),
          _e.unbind(de, L),
      ...
      function j(e) {
        ...
        return (
          !n || i
            ? (t = _)
            : !r || e != w || (C.triggerOnTouchEnd && !C.triggerOnTouchLeave)
            ? !r && e == b && C.triggerOnTouchLeave && (t = _)
            : (t = b),
          t
        );
      }
      function P(e, t) {
        ...
        return (
          ...
          W() && G() && !1 !== n
            ? (n = I(e, t, h))
            : ge > C.longTapThreshold && pe < A && C.longTap && !1 !== n
            ? (n = I(e, t, f))
            : !((1 !== xe && $) || !(isNaN(pe) || pe < C.threshold) || !F()) &&
              !1 !== n &&
              (n = I(e, t, p)),
          t === _ && L(),
          t === b && ((r && r.length) || L()),
        ...
        if (c == u) {
          ...
          if (l == b && H()) {
            if (
              (clearTimeout(Le),
              clearTimeout(qe),
              _e.trigger("swipe", [he, pe, ge, xe, Se, fe]),
              C.swipe &&
                !1 === (g = C.swipe.call(_e, t, he, pe, ge, xe, Se, fe)))
            )
              return !1;
            switch (he) {
              case n:
                _e.trigger("swipeLeft", [he, pe, ge, xe, Se, fe]),
                  C.swipeLeft &&
                    (g = C.swipeLeft.call(_e, t, he, pe, ge, xe, Se, fe));
                break;
              case r:
                _e.trigger("swipeRight", [he, pe, ge, xe, Se, fe]),
                  C.swipeRight &&
                    (g = C.swipeRight.call(_e, t, he, pe, ge, xe, Se, fe));
                break;
              case i:
                _e.trigger("swipeUp", [he, pe, ge, xe, Se, fe]),
                  C.swipeUp &&
                    (g = C.swipeUp.call(_e, t, he, pe, ge, xe, Se, fe));
                break;
              case o:
                _e.trigger("swipeDown", [he, pe, ge, xe, Se, fe]),
                  C.swipeDown &&
                    (g = C.swipeDown.call(_e, t, he, pe, ge, xe, Se, fe));
            }
          }
        }
        if (c == d) {
          if (
            (_e.trigger("pinchStatus", [
              l,
              we || null,
              ye || 0,
              ge || 0,
        ...
        return (
          c == p
                  ...
                  (Le = setTimeout(
                    e.proxy(function () {
                      (De = null),
                        ...
                        C.tap && (g = C.tap.call(_e, t, t.target));
                    }, this),
            ...
            ? (l !== _ && l !== b) ||
              ...
              C.doubleTap && (g = C.doubleTap.call(_e, t, t.target)))
            : c == f &&
              ((l !== _ && l !== b) ||
                (clearTimeout(Le),
                (De = null),
                _e.trigger("longtap", [t.target]),
                C.longTap && (g = C.longTap.call(_e, t, t.target)))),
          g
        );
      }
      function N() {
        var e = !0;
        return null !== C.threshold && (e = pe >= C.threshold), e;
      }
      function R() {
        var e = !1;
        return (
          null !== C.cancelThreshold &&
            null !== he &&
            (e = ee(he) - pe >= C.cancelThreshold),
          e
        );
      }
      function M() {
        return !(C.maxTimeThreshold && ge >= C.maxTimeThreshold);
      }
      function B() {
        var e = Q(),
          t = Y(),
          n = null === C.pinchThreshold || ye >= C.pinchThreshold;
        return e && t && n;
      }
      function U() {
      ...
      function Q() {
        return xe === C.fingers || C.fingers === v || !$;
      }
      function Y() {
        return 0 !== Se[0].end.x;
      }
      ...
      function W() {
        if (null == De) return !1;
        var e = oe();
        return G() && e - De <= C.doubleTapThreshold;
      }
      function K() {
        (Te = 0), (Oe = 0);
      }
      function V() {
        var e = !1;
        Te && oe() - Te <= C.fingerReleaseThreshold && (e = !0);
        return e;
      }
      function Z(e) {
        _e &&
          (!0 === e
            ? (_e.bind(le, O), _e.bind(ce, D), ue && _e.bind(ue, q))
            : (_e.unbind(le, O, !1),
              _e.unbind(ce, D, !1),
              ue && _e.unbind(ue, q, !1)),
          _e.data(E + "_intouch", !0 === e));
      }
      function X(e, t) {
        var n = {
          start: { x: 0, y: 0 },
      ...
      C = e.extend({}, C);
      var se = $ || S || !C.fallbackToMouseEvents,
        ae = se
          ? S
            ? x
              ? "MSPointerDown"
        ...
        ce = se
          ? S
            ...
            : "touchend"
          : "mouseup",
        ue = se ? (S ? "mouseleave" : null) : "mouseleave",
        de = S ? (x ? "MSPointerCancel" : "pointercancel") : "touchcancel",
        pe = 0,
        he = null,
        fe = null,
        ge = 0,
        ...
        qe = null;
      try {
        _e.bind(ae, T), _e.bind(de, L);
      } catch (t) {
        e.error("events not supported " + ae + "," + de + " on jQuery.swipe");
      }
      (this.enable = function () {
        return this.disable(), _e.bind(ae, T), _e.bind(de, L), _e;
      }),
        (this.disable = function () {
          return k(), _e;
        }),
        (this.destroy = function () {
          k(), _e.data(E, null), (_e = null);
        }),
...
function showFileName(e) {
  ...
  infoArea.textContent = "File name: " + t;
}
input.addEventListener("change", showFileName);
var fileInput = document.getElementById("user_group_logo");
(fileInput.onchange = function (e) {
  var t = fileInput.value;
  if (t) {
    var n = t.indexOf("\\") >= 0 ? t.lastIndexOf("\\") : t.lastIndexOf("/"),
      r = t.substring(n);
    (0 !== r.indexOf("\\") && 0 !== r.indexOf("/")) || (r = r.substring(1)),
      $("#user_group_label").text(r);
  }
}),
  (function (e) {
    "use strict";
  ...
  (function (e) {
    ...
    function r(e, t) {
      var n,
        r,
        i = !!t && e.value !== t,
        o = e.value === e.getAttribute(S);
      return (
        !((!i && !o) || "true" !== e.getAttribute(E)) &&
        (e.removeAttribute(E),
        (e.value = e.value.replace(e.getAttribute(S), "")),
        (e.className = e.className.replace(x, "")),
        (r = e.getAttribute(D)),
        parseInt(r, 10) >= 0 &&
          (e.setAttribute("maxLength", r), e.removeAttribute(D)),
        (n = e.getAttribute(C)) && (e.type = n),
        !0)
      );
    }
    function i(e) {
      ...
      return (
        ...
        e.getAttribute(C)
          ...
          : "password" === e.type &&
            P.changeType(e, "text") &&
            e.setAttribute(C, "password"),
        !0)
      );
    }
    function o(e, t) {
      var n, r, i, o, s;
      if (e && e.getAttribute(S)) t(e);
      else
        for (
          r = e ? e.getElementsByTagName("input") : l,
            i = e ? e.getElementsByTagName("textarea") : c,
            s = 0,
            o = (n = r ? r.length : 0) + (i ? i.length : 0);
          o > s;
          s++
        )
          t(n > s ? r[s] : i[s - n]);
    ...
    function a(e) {
      e.form &&
        ...
        v.getAttribute(T) ||
          ...
          v.setAttribute(T, "true"))),
        P.addEventListener(
          e,
          "focus",
          (function (e) {
            return function () {
              u && e.value === e.getAttribute(S) && "true" === e.getAttribute(E)
                ? P.moveCaret(e, 0)
                : r(e);
            };
          })(e)
    ...
    var l,
      ...
      j = e.Placeholders,
      P = j.Utils;
    if (((j.nativeSupport = void 0 !== L.placeholder), !j.nativeSupport)) {
      for (
        l = document.getElementsByTagName("input"),
          c = document.getElementsByTagName("textarea"),
          u = "false" === k.getAttribute("data-placeholder-focus"),
          d = "false" !== k.getAttribute("data-placeholder-live"),
        ...
        for (w = 0, y = l.length + c.length; y > w; w++)
          (A = l.length > w ? l[w] : c[w - l.length]),
            (g = A.attributes.placeholder)
              ? (g = g.nodeValue) &&
                P.inArray(b, A.type) &&
                (A.getAttribute(O) || a(A),
                (g !== A.getAttribute(S) ||
                  ("password" === A.type && !A.getAttribute(C))) &&
                  ("password" === A.type &&
                    !A.getAttribute(C) &&
                    P.changeType(A, "text") &&
                    A.setAttribute(C, "password"),
                  A.value === A.getAttribute(S) && (A.value = g),
                  A.setAttribute(S, g)))
              : A.getAttribute(E) && (r(A), A.removeAttribute(S));
        d || clearInterval(m);
      }, 100);
    }
    P.addEventListener(e, "beforeunload", function () {
      ...
      (j.disable = j.nativeSupport ? t : s),
      (j.enable = j.nativeSupport
        ? t
        : function (e) {
            o(e, i);
          });
  ...
  (function (e) {
    ...
    if (
      ...
      var n,
        ...
        y = "false" !== f.getAttribute("data-placeholder-live"),
        w = document.createElement("style");
      w.type = "text/css";
      var b,
        _,
        $ = document.createTextNode("." + o + " {color:#ccc;}");
      w.styleSheet ? (w.styleSheet.cssText = $.nodeValue) : w.appendChild($),
        h.insertBefore(w, h.firstChild);
      for (var x = 0, S = m.length + v.length; x < S; x++)
        (_ = x < m.length ? m[x] : v[x - m.length]),
          (b = _.attributes.placeholder) &&
            (b = b.nodeValue) &&
            O(r, _.type) &&
            N(_);
      var E = setInterval(function () {
        for (var e = 0, t = m.length + v.length; e < t; e++)
          (_ = e < m.length ? m[e] : v[e - m.length]),
            (b = _.attributes.placeholder)
              ? (b = b.nodeValue) &&
                O(r, _.type) &&
                (_.getAttribute(d) || N(_),
                (b !== _.getAttribute(a) ||
                  ("password" === _.type && !_.getAttribute(c))) &&
                  ("password" === _.type &&
                    !_.getAttribute(c) &&
                    q(_, "text") &&
                    _.setAttribute(c, "password"),
                  _.value === _.getAttribute(a) && (_.value = b),
                  _.setAttribute(a, b)))
              : _.getAttribute(l) && (P(_), _.removeAttribute(a));
        y || clearInterval(E);
      }, 100);
    ...
    function k(e, t) {
      if (e && e.getAttribute(a)) t(e);
        ...
        for (
          var n = e ? e.getElementsByTagName("input") : m,
            r = e ? e.getElementsByTagName("textarea") : v,
            i = n ? n.length : 0,
            o = i + (r ? r.length : 0),
            s = 0;
          s < o;
    ...
    function P(e, t) {
      ...
      if ((n || r) && "true" === e.getAttribute(l)) {
        ...
        parseInt(i, 10) >= 0 &&
          (e.setAttribute("maxLength", i), e.removeAttribute(p));
    ...
    function I(e) {
      ...
      return (
        ...
        (e.className += " " + o),
        e.getAttribute(p) ||
          (e.setAttribute(p, e.maxLength), e.removeAttribute("maxLength")),
        e.getAttribute(c)
          ? (e.type = "text")
          : "password" === e.type &&
            q(e, "text") &&
    ...
    function N(e) {
      ...
      t &&
        "string" == typeof t &&
        ((t = document.getElementById(t)).getAttribute(u) ||
          (D(
            t,
            "submit",
            (function (e) {
        ...
        D(
          ...
          (function (e) {
            return function () {
              A && e.value === e.getAttribute(a) && "true" === e.getAttribute(l)
                ? L(e, 0)
                : P(e);
            };
          })(e)
      ...
      for (
        ...
        if (t[o].hasAttribute("id")) i = t[o].getAttribute("id");
          ...
          (c = s = t[o].textContent
            ...
            (l = 0);
          do {
            void 0 !== a && (c = s + "-" + l), (a = r.indexOf(c)), (l += 1);
          } while (-1 !== a);
        ...
        (u = i.replace(/-/g, " ")),
          ...
          "left" === this.options.placement
            ? ((h[0].style.position = "absolute"),
              ...
              t[o].insertBefore(h[0], t[o].firstChild))
            : ((h[0].style.paddingLeft = "0.375em"), t[o].appendChild(h[0]));
      }
      return this;
    }),
...
(window.PR_SHOULD_USE_CONTINUATION = !0),
  (function () {
    ...
    function t(t, n) {
      ...
      !(function () {
        for (
          var e = t.concat(n), o = [], s = {}, a = 0, l = e.length;
          a < l;
          ++a
        ) {
          var c = e[a],
          ...
          (u = "" + (c = c[1])), s.hasOwnProperty(u) || (o.push(c), (s[u] = q));
        }
        o.push(/[\S\s]/),
          (r = (function (e) {
            function t(e) {
            ...
            function r(e) {
              ...
              for (
                ...
                (a = i[s])[0] <= c[1] + 1
                  ...
                  : r.push((c = a));
              for (
                i = ["["], o && i.push("^"), i.push.apply(i, e), s = 0;
                s < r.length;
                ++s
              )
                (a = r[s]),
            ...
            for (var o = 0, s = !1, a = !1, l = 0, c = e.length; l < c; ++l) {
              var u = e[l];
              if (u.ignoreCase) a = !0;
              else if (
                /[a-z]/i.test(
    ...
    function s(e) {
      ...
      try {
        ...
        var r,
          i,
          s = /\bMSIE\b/.test(navigator.userAgent),
          a = ((t = /\n/g), e.a),
          l = a.length,
          c = 0,
          u = e.c,
        ...
        e = 0;
        for (p[h] = l, i = r = 0; i < h; )
          p[i] !== p[i + 2] ? ((p[r++] = p[i++]), (p[r++] = p[i++])) : (i += 2);
        for (h = r, i = r = 0; i < h; ) {
          for (
            var f = p[i], g = p[i + 1], m = i + 2;
            m + 2 <= h && p[m + 1] === g;
        ...
        for (p.length = r; n < d; ) {
          var v,
            A = u[n + 2] || l,
            y = p[e + 2] || l,
            w = ((m = Math.min(A, y)), u[n + 1]);
          if (1 !== w.nodeType && (v = a.substring(c, m))) {
            s && (v = v.replace(t, "\r")), (w.nodeValue = v);
            ...
            $.replaceChild(_, w),
              _.appendChild(w),
              c < A &&
                ((u[n + 1] = w = b.createTextNode(a.substring(m, A))),
    ...
    i(m, ["default-code"]),
      ...
      (window.prettyPrintOne = function (e, t, n) {
        ...
        return (
          (i.innerHTML = e), n && r(i, n), s({ g: t, i: n, h: i }), i.innerHTML
        );
      }),
      (window.prettyPrint = function (e) {
        for (
          ...
          for (var o = 0, a = t[i].length; o < a; ++o) n.push(t[i][o]);
        t = q;
        var l = Date;
        l.now ||
          (l = {
        ...
        !(function t() {
          for (
            ...
            var o = n[c];
            if ((a = o.className).indexOf("prettyprint") >= 0) {
              var a, d, p;
              if ((p = !(a = a.match(u)))) {
                for (
                  var h = void 0, f = (p = o).firstChild;
                  f;
                  f = f.nextSibling
                ) {
                  var m = f.nodeType;
              ...
              p ||
                ((p =
                  !!(p = o.className.match(/\blinenums\b(?::(\d+))?/)) &&
                  (!p[1] || !p[1].length || +p[1])) && r(o, p),
                s({ g: a, h: o, i: p }));
            }
          }
            ...
            return (
              (e.prototype.query = function (e, t, n) {
                ...
                this.current(function (i) {
                  ...
                  r.maximumSelectionLength > 0 && o >= r.maximumSelectionLength
                    ? r.trigger("results:message", {
                ...
                (O.prototype.apply = function (d) {
                  ...
                  if ("string" == typeof d.language)
                    if (d.language.indexOf("-") > 0) {
                      var k = d.language.split("-")[0];
                      d.language = [d.language, k];
                ...
                (i.prototype.fromElement = function (e) {
                  ...
                  i =
                    ...
                    e[0].dataset
                      ...
                      : e.data();
                  var o = t.extend(!0, {}, i);
                  for (var s in (o = r._convertData(o)))
                    t.inArray(s, n) > -1 ||
              ...
              return (
                (r.prototype.render = function (r) {
                  ...
                  return (
                    ...
                    t.syncCssClasses(i, this.$element, s),
                    i.css(l),
                    i.addClass(o),
                    i
                  );
            ...
            return (
              (t.prototype.current = function (t, n) {
                ...
                for (var i = [], o = 0; o < this._currentData.length; o++) {
                  ...
                  i.push.apply(
                    i,
                    r(s, this.$element.val().split(this._valueSeparator))
                  );
                }
                n(i);
              }),
          ...
          (o = function (e) {
            ...
            function l(r) {
              var i,
                ...
                g = 0;
              if (
                (((r = e.event.fix(s)).type = "mousewheel"),
                ...
                if (
                  ((i = Math.max(Math.abs(h), Math.abs(p))),
                  (!n || i < n) && ((n = i), u(s, i) && (n /= 40)),
                  u(s, i) && ((d /= 40), (p /= 40), (h /= 40)),
