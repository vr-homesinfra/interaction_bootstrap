...
$(document).on("click touch", '[data-dismiss="drawer"]', {}, closeDrawer),
  $(document).on("click touch", '[data-dismiss="left-drawer"]', {}, function (
    e
  ) {
    closeDrawer(e, getLeftDrawer());
  }),
  $(document).on("click touch", '[data-dismiss="right-drawer"]', {}, function (
    e
  ) {
...
//       $(".profiles-list").addClass("d-block");
//       $(".profiles-list").removeClass("d-none");
//   }),
//   $(document).on("click", function(event){
//     var $trigger = $(".dropdown");
//     if($trigger !== event.target && !$trigger.has(event.target).length){
//         $(".profiles-list").removeClass("d-block");
//         $(".profiles-list").addClass("d-none");
//     }            
// }),
$(".profiles-list-mobile").on("click", function(){
  // alert($(this).text());
  $(".profiles-list-mobile").removeClass("d-block");
  $(".profiles-list-mobile").addClass("d-none");
}),

$(document).ready(function(){
  if ($(window).width() > 1500) {
      $(".orange-drawer").addClass('open');
  }  
}),
...
$(window).resize(function () {
      if ($(window).width() < 1500) {
          $(".orange-drawer").removeClass('open');  
      }
});
